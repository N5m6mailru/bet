       ...
       <?foreach($html->find('h3') as $h3):?>  
        ...
        <?foreach($h3->next_sibling()->children() as $div):?>
          <div class="col-md-2 p-2">
            <a href='https://xn----7sbab5aqcbiddtdj1e1g.xn--p1ai/<?=$div->find('a',0)->href; ?>'>
              <div class="card">
                <div class="card-header"><?=$div->find('div(".card-header',0)->plaintext; ?></div>
                <img src='https://xn----7sbab5aqcbiddtdj1e1g.xn--p1ai<?= explode('..',$div->find('img',0)->src)[1]; ?>' style="width: 99%" alt="">
              </div>
            </a>
          </div>
